// Grid math + hand-rolled pointer drag/drop + resize for the workspace view.
//
// Pure functions only — no DOM, no transport. A view wires pointer events to
...
// free slot). Keeping the geometry here makes it unit-testable and keeps the view
// a thin renderer.

import { DASHBOARD_GRID_COLUMNS, type DashboardGridRect, type DashboardWidget } from "./types.js";

/** Fixed row height + gutter, in CSS pixels. */
