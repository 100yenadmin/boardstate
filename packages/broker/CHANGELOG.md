...
- [#57](https://github.com/100yenadmin/boardstate/pull/57) [`ed04514`](https://github.com/100yenadmin/boardstate/commit/ed045143d925ba7a6479c8e969ee7e4beb0cc0f9) Thanks [@100yenadmin](https://github.com/100yenadmin)! - feat(broker): first-party connector presets — OfficeCLI + Pipedream + Composio (M5e + M5f-1)

  Named recipes that stamp out a validated operator `ConnectorConfig`: `officeCliPreset`
  (stdio `officecli mcp`, the first blessed first-party connector, [#46](https://github.com/100yenadmin/boardstate/issues/46)), `pipedreamPreset`
  and `composioPreset` (remote Streamable-HTTP aggregators behind env-ref headers, [#47](https://github.com/100yenadmin/boardstate/issues/47)), a
