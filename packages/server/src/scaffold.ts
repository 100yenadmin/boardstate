// Custom-widget scaffolding (SPEC §8). Writes a framework-free, network-free
// starter widget (`widget.json` + `index.html` + `README.md`) under the dashboard
// state dir. The scaffold NEVER approves: the caller registers the widget as
// `pending` (SPEC §8.2). The template demonstrates the v1 bridge handshake, a
// declared binding, theme tokens, and ZERO external requests.
...
// Scaffold template (SPEC §7/§8): demonstrates the v1 handshake, getData + push,
// theme tokens applied to CSS vars, ZERO external requests, and a visible "built by
// <createdBy>" footer. Framework-free and < 100 lines.
